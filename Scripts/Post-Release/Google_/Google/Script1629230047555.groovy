...
WebUI.setText(findTestObject('Google/input_Use your Google Account_identifier'), username)

WebUI.click(findTestObject('Google/span_Next (1)'))

WebUI.delay(4)

WebUI.setText(findTestObject('Google/input_Too many failed attempts_password'), password)

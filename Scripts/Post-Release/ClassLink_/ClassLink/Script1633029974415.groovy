...
WebUI.setText(findTestObject('ClassLink/input_What will you explore today_username'), username)

WebUI.setText(findTestObject('ClassLink/input_Username_password'), password)

WebUI.click(findTestObject('ClassLink/button_Sign In'))
